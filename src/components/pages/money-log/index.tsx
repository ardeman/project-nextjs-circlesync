...
export const MoneyLogPage = () => {
  return (
    <main className="bg-muted/40 chart-wrapper mx-auto flex flex-1 flex-col flex-wrap items-start justify-center gap-4 p-4 sm:flex-row sm:p-8 md:gap-8 md:p-8">
